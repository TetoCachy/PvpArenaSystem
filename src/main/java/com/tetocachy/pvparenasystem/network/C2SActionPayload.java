...
public record C2SActionPayload(String action, String param1, String param2, int intParam1, int intParam2, int intParam3) implements CustomPacketPayload {
    ...
    public C2SActionPayload(String action, String param1, String param2, int intParam1, int intParam2) {
        this(action, param1, param2, intParam1, intParam2, 0);
    }
